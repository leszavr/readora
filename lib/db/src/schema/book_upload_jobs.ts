import { pgEnum, pgTable, serial, integer, text, timestamp, real, boolean, index } from "drizzle-orm/pg-core";
...
export const bookUploadJobsTable = pgTable("book_upload_jobs", {
  ...
  index("book_upload_jobs_owner_status_idx").on(t.ownerUserId, t.status),
]);
